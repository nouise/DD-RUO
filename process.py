...
def pdf_to_png(original_folder, target_folder):
    # 遍历文件夹中的所有文件
...
if __name__ == "__main__":
    # 设置包含PDF的文件夹路径
    original_folder=r"D:\2025\DD-RUO\figures"
    target_folder = r"D:\2025\DD-RUO\static\results\full_images"  # 修改为你的文件夹路径
    pdf_to_png(original_folder, target_folder)